        ...
        <form method="POST" action="{{ route('projects.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500">{{ old('description') }}</textarea>
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('projects.index') }}" class="text-gray-500 text-sm hover:underline">取消</a>
            </div>
        </form>
    </div>
</x-records-layout>
