...
<head>
    ...
    <title>{{ config('app.name') }} - {{ $title ?? '擐?' }}</title>
...
<div class="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 px-4 py-4 space-y-6 overflow-y-auto">
            ...
            {{-- 蝟餌絞蝮質汗 --}}
            <div>
                <div class="px-2 mb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">蝟餌絞蝮質汗</div>
            ...
            {{-- ?蝝??--}}
            <div>
                <div class="px-2 mb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">?蝝??/div>
                <div class="space-y-1">
            ...
            {{-- 撠?蝞∠? --}}
            <div>
                <div class="px-2 mb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">撠?蝞∠?</div>
                <div class="space-y-1">
            ...
            @if(isset($currentProject) || request()->route('project'))
                ...
                <div>
                    <div class="px-2 mb-2 text-xs font-semibold text-indigo-500 uppercase tracking-wider flex items-center">
                        <span class="truncate w-full" title="{{ $proj->name }}">撠?嚗{ $proj->name }}</span>
                    </div>
                    <div class="space-y-1">
        ...
        <div class="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
            <button @click="darkMode = !darkMode" class="w-full group flex items-center px-2 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-md hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/50 dark:hover:bg-gray-800 transition-colors">
                ...
                <span x-text="darkMode ? '??鈭株璅∪?' : '???璅∪?'"></span>
            </button>
            <a href="{{ route('profile.edit') }}" class="group flex items-center px-2 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-md hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/50 dark:hover:bg-gray-800 transition-colors">
