    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
            <div class="border-b border-gray-100 pb-4 mb-6 flex justify-between items-center">
                ...
                <a href="{{ route('project-files.download', $projectFile) }}" class="text-sm bg-indigo-50 dark:bg-indigo-900/50 text-indigo-700 px-3 py-1.5 rounded hover:bg-indigo-100">⬇ 下載檔案</a>
            </div>
