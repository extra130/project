...
<body class="bg-gray-50 min-h-screen flex flex-col">
    <div class="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <button onclick="window.close()" class="text-sm bg-gray-100 text-gray-700 px-4 py-2 rounded hover:bg-gray-200 transition">關閉預覽</button>
    </div>
    
    <div class="flex-grow p-4 md:p-8 flex items-center justify-center">
        <div class="w-full h-full bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden" style="min-height: 80vh;">
            @php
