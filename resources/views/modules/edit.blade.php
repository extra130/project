        ...
        <form method="POST" action="{{ route('modules.update', $module) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded px-3 py-2 text-sm">{{ old('description', $module->description) }}</textarea>
            </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('projects.modules.index', $module->project_id) }}" class="text-gray-500 text-sm hover:underline">取消</a>
            </div>
        </form>
    </div>
</x-records-layout>
